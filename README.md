# nvim-treesitter-queries-ninja

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ninja/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ninja/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ninja**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ninja",
...
- [ ] Changes are scoped to `ninja` — do not include files for other languages
